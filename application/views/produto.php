    ...
    <div class="row-fluid">
        ...
        <div class="span3">
            ...
            form_open(base_url('carrinho/adicionar'));
                ...
                form_input(array('name' => 'quantidade', 'Placeholder' => 'Quantidade', 'value' => 1)) .
                form_submit(array('name' => 'adicionar', 'value' => 'Adicionar ao carrinho', 'class' => 'btn btn-default')) .
            form_close();
            ?>
        </div>
    </div>
